...
public class WeatherActivity extends AppCompatActivity {
     ...
     * 根据天气id请求城市天气信息
     *
     * @param weatherId 请求的城市id
     */
    public void requestWeather(final String weatherId) {
        String weatherUrl = "https://free-api.heweather.com/v5/weather?city=" + weatherId + "&key=34450d04fe7d4479b2d1db748ff8cafa";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        //这里用正则表达式拆分字符串为一个字符串数组,返回第二个索引位置对应的字符串就是时间
